...
const NOSCRIPT = {
  ...
  motifs: ['Four families of motif',
    "Every piece carries one of a small family of Dayak motifs: aso' the dragon-dog, tinggang the hornbill, kelunan the human figure, and the mata punai border patterns."],
